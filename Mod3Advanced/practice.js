...
// let timerId = setTimeout(printMessage, 2000) // Message: prints after 2 sec
...
// new Animal('fuzzy wuzzy').describe() // fuzzy wuzzy is a anima
...
// new Rabbit('bunny').describe() // bunny is a rabbit
// new Animal('fuzzy wuzzy').describe() // fuzzy wuzzy is a animal
// new Fox('Swiper').describe() // fuzzy wuzzy is a animal
...
// console.log('caught an error: '+ e.message) // all errors have a message property
// }
...
// console.log('only synchronous errors! ' + e.message) // all errors have a message property
// }
...
// return false
// // }
// return false; // returns false if any error occurre
//  checkJson(`{"name":"luis"}`)
...
// .catch( (e) => console.log('Error! ' + e ) ) // prints reject msg
...
// let start = 10;
// new Promise( resolve => setTimeout(() => resolve(start), start * 50)
// ).then(result => { // promise handler function inside .then()
// console.log(result); let next = result + start;
// return new Promise( resolve => setTimeout(() => resolve(next), next * 50) );
